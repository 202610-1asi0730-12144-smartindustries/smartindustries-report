...
**Segmento Objetivo**
-¿Actualmente cómo se maneja el ingreso y egreso de personas autorizadas al establecimiento?
-¿Qué sistemas ocupan para el registro y control de estos ingresos? (de haberlo).
